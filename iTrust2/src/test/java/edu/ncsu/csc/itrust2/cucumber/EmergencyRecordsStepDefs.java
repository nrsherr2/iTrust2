...
public class EmergencyRecordsStepDefs {
	...
	public void setup() {
		...
		final User hcp = new User("hcp", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_HCP, 1);
		hcp.save();

		final User er = new User("Emergency", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_HCP, 1);
		er.save();
	}
	...
	@When("When I fill in the username of the patient")
	...
	@Then("Then the patients medical information is displayed")
	public void checkRecords() {

		String[] expected = { PATIENT_NAME, PATIENT_DOB, PATIENT_GENDER, PATIENT_BLOOD };
